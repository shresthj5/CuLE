...
static std::map<GAME_TYPE, std::array<std::string,_ROM_ATTR_MAX>> rom_attr_data =
{
    ...
    // 4K Games
    { GAME_ADVENTURE, {{"Atari", "CX2613 / 4975154", "Adventure (1978) (Atari) (PAL) [!]", "", "Common", "", "", "", "", "", "", "", "NONE", "", "", "", "250", "", "", "" }}},
    { GAME_AIR_RAID, {{"", "C-817", "Air Raid (Men-A-Vision) (PAL)", "", "Extremely Rare", "", "", "", "", "", "", "", "", "", "", "", "250", "YES", "", "" }}},
    ...
    { GAME_CARNIVAL, {{"CBS Electronics", "", "Carnival (1983) (CBS Electronics) (PAL) [!]", "", "", "", "", "", "", "", "", "", "", "", "", "26", "214", "", "", "" }}},
    ...
    { GAME_POOYAN, {{"Konami-Gakken", "", "Pooyan (1982) (Konami-Gakken) (PAL) [!]", "", "", "", "", "", "", "", "", "", "", "", "", "26", "220", "", "", "" }}},
